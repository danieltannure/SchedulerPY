...
class AdaptiveLabel(QLabel):
    ...
    def paintEvent(self, e):
        ...
        painter.setRenderHint(QPainter.Antialiasing)  # suaviza cantos
        ...
        radius = 100
        color = None
        # tenta obter pelo styleSheet (quando usado em create_widget)
        ss = self.styleSheet()
        if "background-color" in ss:
            # extrai após dois-pontos até ponto-e-vírgula
